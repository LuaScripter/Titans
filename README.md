...
hum.WalkSpeed = 7
char.Health:Destroy()
hum.MaxHealth = 9999999999999999999999999999999999999
wait(0.1)
hum.Health = 9999999999999999999999999999999999999
----------------------------------------------------
...
pants.Name = "Pants"
char.Shirt.ShirtTemplate = "http://www.roblox.com/asset/?id=2477011371"
char.Pants.PantsTemplate = "http://www.roblox.com/asset/?id=477012882"
----------------------------------------------------
Debounces = {
on = false;
ks = false;
...
----------------------------------------------------
game:service'InsertService':LoadAsset(382881117):children()[1].Parent=char
char.TixWings.Handle.Mesh.Scale = char.TixWings.Handle.Mesh.Scale * 1.8
char.TixWings.Handle.Mesh.VertexColor = Vector3.new(1,1,1)
...
----------------------------------------------------
game:service'InsertService':LoadAsset(335080779):children()[1].Parent=char
char.DominusPittacium.Handle.Mesh.Scale = char.DominusPittacium.Handle.Mesh.Scale * 1.8
char.DominusPittacium.Handle.Mesh.VertexColor = Vector3.new(1,1,1)
----------------------------------------------------

z = Instance.new("Sound", char)
z.SoundId = "rbxassetid://171095556 "--242463565
z.Looped = true
z.Pitch = 1.1
z.Volume = 1
wait(.01)
...
game.Players.LocalPlayer.Humanoid.MaxHealth = 9999999999999999999999999999999999999
wait()
game.Players.LocalPlayer.Humanoid.Health = 9999999999999999999999999999999999999
